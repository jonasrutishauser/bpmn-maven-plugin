...
public class ModelsReportRendererTest
{
        ...
        throws IOException
    {
        ...
        ModelsReportRenderer testee =
            new ModelsReportRenderer( sink,
                                      new ReportConfiguration( new File( "" ),
                                                               Collections.singletonList( new File( MODELS_DIRECTORY,
                                                                                                    "diagram.bpmn" ) ),
    ...
    void getProcessName_aBpmn_processName()
        throws IOException
    {
    ...
    void getProcessName_invalid_null()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getDecisionName_aDmn_firstDecisionName()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getDecisionName_aBpmn_null()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getDecisionName_invalid_null()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getCaseName_aCmmn_processName()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getCaseNameName_aDmn_null()
        throws IOException
    {
        ModelsReportRenderer testee = new ModelsReportRenderer( null, null );
    ...
    void getScripts_renderABpmn_bpmnScripts()
        throws IOException
    {
        ModelsReportRenderer testee =
            new ModelsReportRenderer( new SiteRendererSink( new RenderingContext( BASEDIR, "test.html" ) ),
                                      new ReportConfiguration( new File( "" ),
                                                               Collections.singletonList( new File( MODELS_DIRECTORY,
                                                                                                    "diagram.bpmn" ) ),
                                                               Collections.emptyList(), Collections.emptyList() ) );
    ...
    void getScripts_renderADmn_dmnScripts()
        throws IOException
    {
        ModelsReportRenderer testee =
            new ModelsReportRenderer( new SiteRendererSink( new RenderingContext( BASEDIR, "test.html" ) ),
        ...
        assertEquals( new HashSet<>( Arrays.asList( "dmn-js/dmn.js", "dmn-js/dmn-viewer.min.js",
                                                    "dmn-js/css/dmn-js.css" ) ),
                      scripts );
    }

    @Test
    @DisplayName( "getScripts() after render() of a cmmn returns correct scripts" )
    void getScripts_renderACmmn_cmmnScripts()
        throws IOException
    {
        ModelsReportRenderer testee =
            new ModelsReportRenderer( new SiteRendererSink( new RenderingContext( BASEDIR, "test.html" ) ),
